...
<html>  
  <head>
    ...
    <script type="text/javascript" src="${stx}/X-admin/lib/layui/layui.js" charset="utf-8"></script>
  ...
  <body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a href="">系统管理</a><a><cite>用户列表</cite></a>
	...
	<div class="x-body">		
		...
		<table class="layui-table">
			...
			<tbody>
				<c:forEach items="${userList}" var="user" varStatus="status">
					<tr>
						...
						<td class="td-manage"><a onclick="member_stop(this,'10001')"
							...
							onclick="x_admin_show('编辑','${ctx}/user/edit/${user.id }',600,400)"
				...
				<c:forEach var="list" begin="1" end="${20 - fn:length(userList)}"
					step="1">
					<tr class="c2">
